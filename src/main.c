...
//  if (hour > 6 && hour < 13 && false){
//    s_background_bitmap = gbitmap_create_with_resource(RESOURCE_ID_SUN);
//  }
//  else{
//    s_background_bitmap = gbitmap_create_with_resource(RESOURCE_ID_MOON);
//  }
//  s_background_bitmap = gbitmap_create_with_resource(RESOURCE_ID_MOON);
...
static void main_window_load(Window *window) {
  ...
  s_time_layer = text_layer_create(GRect(5, 78, 139, 90));
